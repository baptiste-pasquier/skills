...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `docs-taxonomy` | Restructure a project's `docs/` into a MECE, enforced taxonomy — Diátaxis quadrants plus an append-only journal — so humans and coding agents both have exactly one place to put each paragraph. Ships a diagnosis procedure, file templates, and a CI gate. | [baptiste-pasquier/skills/docs-taxonomy](https://skills.sh/baptiste-pasquier/skills/docs-taxonomy) | `npx skills add https://github.com/baptiste-pasquier/skills --skill docs-taxonomy` |
